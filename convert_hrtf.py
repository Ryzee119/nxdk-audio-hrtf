...
Usage:
  python3 convert_sonicom_hrtf.py <sofa_file> [--output nxaudio_hrtf.h]
...
def write_header_file(filepath, filters, filter_index, sofa_filename):
    ...
    with open(filepath, "w") as f:
        ...
        f.write(" *\n")
        f.write(" * Generated by convert_sonicom_hrtf.py\n")
        f.write(" */\n\n")
...
Example:
  python3 convert_sonicom_hrtf.py P0001_FreeFieldCompMinPhase_48kHz.sofa -o nxaudio_hrtf.h
""")
